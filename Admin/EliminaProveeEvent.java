 ...
 */
public class EliminaProveeEvent implements Initializable {
    ...
    public void setUsuario(String usua){
        ...
        error.setText(usua);
        itm.addAll(metodos.proveedores());
    ...
    public void eliminar(){
        Metodos metodos=new Metodos();
        if(metodos.Elimnaprovee(usuario.getSelectionModel().getSelectedItem().toString().substring(0,usuario.getSelectionModel().getSelectedItem().toString().indexOf(":")),error.getText(),contra.getText())){
