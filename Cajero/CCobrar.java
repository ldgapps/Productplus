 ...
 */
public class CCobrar extends Application {
        private Stage stage;
    private AnchorPane rootPane;
    @Override
    public void start(Stage stage) throws Exception {
        this.stage = stage;
        Parent root = FXMLLoader.load(getClass().getResource("CCobrar.fxml"));
    ...
    public static void main(String[] args) {
        launch(args);
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("CCobrar.fxml"));
                ...
                try {
                    ...
                    Logger.getLogger(CCobrar.class.getName()).log(Level.SEVERE, null, ex);
                }
                ventana.show();
